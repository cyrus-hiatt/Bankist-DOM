...
/* // Sticky navigation - not performance friendly
...
const headerObserver = new IntersectionObserver(stickyNav, {
  root: null,
  threshold: 0,
  rootMargin: `-${navHeight}px`, // 90px outside of margin
});
...
const alertH1 = function (e) {
  ...
  //h1.removeEventListener('mouseenter', alertH1); // Listen to event once
};
...
/* // Event Propogration Propogation in Practice
...
document.querySelector('.nav__link').addEventListener('click', function (e) {
  ...
  // Stop propagation - the parent events do not happen
  e.stopPropagation();
});
